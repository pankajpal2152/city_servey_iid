...
- View specific project details with JWT protection
- View customer-wise project details with JWT protection
...
### Step 12: Test Protected Specific Project Details API
...
- HTTP 200
- Response contains `status: true` when the project id exists
- Response contains specific project details from the stored procedure

### Step 13: Test Protected Customer-Wise Project Details API
...
- HTTP 200
- Response contains `status: true` when the customer id has projects
- Response contains customer-wise project details from the stored procedure

### Step 14: Test Protected Project API Routing Safely
...
### Step 15: Test Protected System Role List API
...
### Step 16: Test Protected System Role API Routing Safely
...
### Step 17: Test Protected Survey Type List API
...
### Step 18: Test Protected Survey Type API Routing Safely
...
### Step 19: Test Protected Property Type List API
...
### Step 20: Test Protected Property Type API Routing Safely
...
### Step 21: Test Protected Master Details API
...
14. "Then I will show the specific project details API using PROJECT_SYS_ID."
15. "For project add/update, I will show the protected route validation. The
...
To validate the specific project details route without writing data:
...
console.log(specificProjectResponse.status, await specificProjectResponse.json());
```

To validate the customer-wise project details route without writing data:
...
console.log(customerWiseProjectResponse.status, await customerWiseProjectResponse.json());
```
